      ...
      {Object.values(props.currentBio).length > 0 ? (
        ...
        <>
          ...
          <div className="team-page__intro-text">
            ...
            Tortor condimentum lacinia quis vel eros donec. Id cursus metus
            aliquam eleifend mi in nulla posuere sollicitudin. Neque laoreet
            suspendisse interdum consectetur libero id faucibus nisl. Ipsum a
            arcu cursus vitae congue mauris rhoncus. Id neque aliquam vestibulum
            morbi. Ut lectus arcu bibendum at varius vel pharetra vel. Sed felis
            eget velit aliquet sagittis id consectetur. Nulla facilisi etiam
            dignissim diam quis. Et malesuada fames ac turpis egestas maecenas
            pharetra convallis. Dignissim diam quis enim lobortis. Faucibus
            scelerisque eleifend donec pretium vulputate. Egestas sed sed risus
            pretium quam. Vel elit scelerisque mauris pellentesque. Sed euismod
