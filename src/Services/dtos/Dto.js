...
export default class Dto {
  ...
  serialize() {
    return Object.entries(this._fields).reduce((serializedObject, [key, value]) => {
  ...
  static deserialize(fields) {
    const deserializedFields = Object.entries(fields).reduce((deserializedObject, [key, value]) => {
